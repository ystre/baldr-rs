...
## [0.3.0](https://github.com/ystre/baldr-rs/compare/v0.2.2...v0.3.0) - 2026-09-19

### Other

- Rename repository to baldr-rs ([#19](https://github.com/ystre/baldr-rs/pull/19))
- [**breaking**] Config file is now read from project directory ([#17](https://github.com/ystre/baldr-rs/pull/17))
